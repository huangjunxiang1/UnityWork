...
//                            bool isOptional = arr2.Length == 4 && arr2[0] == "optional";
...
//                            elementType ft = getFieldTypeEnum(rowType);
...
//                                }
//                                else if (getFieldTypeEnum(vRowType) == elementType.Value)
//                                {
...
//                                if (getFieldTypeEnum(vRowType) == elementType.Value)
...
//    elementType getFieldTypeEnum(string type)
//    {
//        if (type == "bool"
//            || type == "int32"
//            || type == "uint32"
