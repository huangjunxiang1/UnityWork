...
public static partial class SettingM
{
	...
	public static FreedomCameraSetting FreedomCameraSetting => _FreedomCameraSetting ??= (FreedomCameraSetting)Client.Loader.Load<ScriptableObject>("config_FreedomCameraSetting");
}
...
public class CMInput
{
    public CMInput()
    {
        this.Asset = Client.Loader.Load<UnityEngine.InputSystem.InputActionAsset>("config_CMInput");
        this.Asset.Enable();
...
public class PlayerControl
{
    ...
    {
        this.Asset = Client.Loader.Load<UnityEngine.InputSystem.InputActionAsset>("config_PlayerControl");
        this.Asset.Enable();
