...
namespace Main
{
    ...
    /// </summary>
    public static unsafe class Recast
    {
        //private const string RecastDLL = "RecastNavDll";
        private const string RecastDLL = "Recast";
        ...
        [DllImport(RecastDLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern bool recast_loadmap(int id, string path);
        ...
        /// <returns></returns>
        public static bool LoadMap(int id, string path)
        {
        ...
        {
            {
                ...
                {
                    Loger.Error(string.Concat("错误:", ($"Recast寻路 FindPath Error：- 起点非法 - spos:{spos} - MapId:{id}")));
                }
            ...
            }
            {
                ...
                {
                    Loger.Error(string.Concat("错误:",($"Recast寻路 FindPath Error：- 终点非法 - epos:{epos} - MapId:{id}")));
                }
            ...
            if (dtStatusFailed(status))
            {
                ...
                Loger.Error(string.Concat("错误:",_strLastError));
                return false;
            }
        ...
        public static float[] getHitPosition(int id)
        {
            unsafe
            {
                ...
                {
                    Loger.Error(string.Concat("错误:",($"RecstInterface getHitPosition Exception! - {e}")));
                    return null;
                }
            }
        }
        ...
        public static float[] fixposition(int id, Vector3 pos)
        {
            unsafe
            {
                ...
                {
                    Loger.Error(string.Concat("错误:",($"RecstInterface fixposition Exception! - {e}")));
                    return null;
                }
            }
        }
