...
partial class FUIGame : FUI
{
    ...
    public GButton _genMap { get; private set; }

    protected sealed override void Binding()
    {
        GComponent ui = this.ui;
        _tips2 = (G_Tips)ui.GetChildAt(1);
        _genMap = (GButton)ui.GetChildAt(2);
    }
    public override void Dispose()
    {
        base.Dispose();
...
partial class FUIWorld : FUI
{
    ...
    public GTextField _res { get; private set; }
    ...
    protected sealed override void Binding()
    {
        ...
        _res = (GTextField)ui.GetChildAt(1);
        _logging = (GButton)ui.GetChildAt(2);
    }
    public override void Dispose()
    {
        base.Dispose();
