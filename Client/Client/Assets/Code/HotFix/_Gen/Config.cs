...
public static partial class SettingL
{
	...
	public static LockingCameraSetting LockingCameraSetting => _LockingCameraSetting ??= (LockingCameraSetting)Game.Loader.Load<ScriptableObject>("config_LockingCameraSetting");
}
...
public class ESCInput
{
    public ESCInput()
    {
        this.Asset = Game.Loader.Load<UnityEngine.InputSystem.InputActionAsset>("config_ESCInput");
        this.Asset.Enable();
