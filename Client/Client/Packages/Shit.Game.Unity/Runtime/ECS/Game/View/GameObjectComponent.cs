...
namespace Game
{
    ...
    {
        internal GameObjectComponent(SGameObjectType style)
        {
            this.gameObjectType = style;
            if (style == SGameObjectType.LogicRoot)
            {
                this.gameRoot = new GameObject();
                this.gameRoot.transform.SetParent(GameM.World.transform);
            }
        }
                ...
                case SGameObjectType.Resource:
                    ...
                    if (this.gameObject)
                    {
                        ...
                        if (release)
                            ...
                            this.gameObject.transform.parent = GameM.World.transform;
                    }
                    else
                    {
                        if (res)
                        {
                            res.transform.SetParent(GameM.World.transform);
        ...
        [Event]
        static void change(Change<GameObjectComponent, TransformComponent> t)
        {
