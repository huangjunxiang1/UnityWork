...
{
    [MenuItem("ILRuntime/安装VS调试插件", false, 5)]
    ...
    [MenuItem("ILRuntime/打开ILRuntime中文文档", false, 5)]
    static void OpenDocumentation()
    {
        Application.OpenURL("https://ourpalm.github.io/ILRuntime/");
    }

    [MenuItem("ILRuntime/打开ILRuntime Github项目", false, 5)]
    static void OpenGithub()
    {
        Application.OpenURL("https://github.com/Ourpalm/ILRuntime");
    }

    [MenuItem("ILRuntime/打开ILRuntime视频教程", false, 5)]
