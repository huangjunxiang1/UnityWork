...
public class AnyChange<T1, T2> : __ChangeHandle where T1 : SComponent where T2 : SComponent
{
    public AnyChange(T1 t1, T2 t2)
    {
        this.t = t1;
        this.t2 = t2;
    }
    ...
    internal static void TryCreateHandle(SObject target)
    {
        ...
        var v = new AnyChange<T1, T2>(c, c2);
...
public class AnyChange<T1, T2, T3> : __ChangeHandle where T1 : SComponent where T2 : SComponent where T3 : SComponent
{
    public AnyChange(T1 t1, T2 t2, T3 t3)
    {
        this.t = t1;
        this.t2 = t2;
        this.t3 = t3;
    ...
    internal static void TryCreateHandle(SObject target)
    {
        ...
        var v = new AnyChange<T1, T2, T3>(c, c2, c3);
        c._changeHandles ??= ObjectPool.Get<List<__ChangeHandle>>();
        c._changeHandles.Add(v);
        c2._changeHandles ??= ObjectPool.Get<List<__ChangeHandle>>();
        c2._changeHandles.Add(v);
...
public class AnyChange<T1, T2, T3, T4> : __ChangeHandle where T1 : SComponent where T2 : SComponent where T3 : SComponent where T4 : SComponent
{
    public AnyChange(T1 t1, T2 t2, T3 t3, T4 t4)
    {
        this.t = t1;
        this.t2 = t2;
        this.t3 = t3;
    ...
    internal static void TryCreateHandle(SObject target)
    {
        ...
        var v = new AnyChange<T1, T2, T3, T4>(c, c2, c3, c4);
        c._changeHandles ??= ObjectPool.Get<List<__ChangeHandle>>();
        c._changeHandles.Add(v);
        c2._changeHandles ??= ObjectPool.Get<List<__ChangeHandle>>();
        c2._changeHandles.Add(v);
...
public class AnyChange<T1, T2, T3, T4, T5> : __ChangeHandle where T1 : SComponent where T2 : SComponent where T3 : SComponent where T4 : SComponent where T5 : SComponent
{
    public AnyChange(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
    {
        this.t = t1;
        this.t2 = t2;
        this.t3 = t3;
    ...
    internal static void TryCreateHandle(SObject target)
    {
        ...
        var v = new AnyChange<T1, T2, T3, T4, T5>(c, c2, c3, c4, c5);
        c._changeHandles ??= ObjectPool.Get<List<__ChangeHandle>>();
        c._changeHandles.Add(v);
        c2._changeHandles ??= ObjectPool.Get<List<__ChangeHandle>>();
        c2._changeHandles.Add(v);
