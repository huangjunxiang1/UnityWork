...
namespace Main
{
    ...
    {
        static Dictionary<Type, ushort> _opCode = new Dictionary<Type, ushort>();
        static Dictionary<ushort, Type> _opType = new Dictionary<ushort, Type>();
        static Dictionary<Type, Type> _requestResponse = new Dictionary<Type, Type>();
        public static void AddTypes(Type[] lst)
        {
            int len = lst.Length;
            for (int i = 0; i < len; i++)
            {
